...
class _FallbackClient implements FallbackClient {
  ...
  Future<CalendarPublic> getCalendarCalendarsCalendarIdGet({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late CalendarPublic _value;
    try {
      _value = CalendarPublic.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<EventPublic>> listEventsCalendarsCalendarIdEventsGet({
    ...
    late List<EventPublic> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => EventPublic.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<EventPublic> createEventCalendarsCalendarIdEventsPost({
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late EventPublic _value;
    try {
      _value = EventPublic.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<CalendarPublic>> listCalendarsCalendarsGet({
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CalendarPublic> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => CalendarPublic.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  @override
  Future<Map<String, String>> readRootGet({RequestOptions? options}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<Map<String, num>> triggerErrorErrorGet({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Map<String, num> _value;
    try {
      _value = _result.data!.cast<String, num>();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
